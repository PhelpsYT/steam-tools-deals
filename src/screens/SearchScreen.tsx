...
const SearchScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <SteamHeader />
      <SteamSubHeader tabs={LIBRARY_TABS} activeTab={activeTab} onTabPress={handleTabPress} />
      <LoadingLine visible={isLoading} />
      <Animated.View style={[styles.content, { transform: [{ translateY }] }]} {...panResponder.panHandlers}>
        <Text style={styles.offlineText}>An internet connection is required{'\n'}to view this content</Text>
      </Animated.View>
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  statusBarBg: { backgroundColor: colors.background.secondary },
  content: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 20 },
  offlineText: { fontFamily: 'Inter_400Regular', fontSize: 20, color: '#DFE3E6', textAlign: 'center' },
});
